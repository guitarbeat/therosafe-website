      ...
      <div>
        ...
        <main>
          ...
          <section
            id="about"
            ref={this.about}
            className={this.state.aboutActive}
          >
            <div className="graphic">
              <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <circle cx="50" cy="50" r="50" />
              </svg>
              <img src="./css/img/therosafe.png" />
            </div>
            <div className="text">
              <h2>About</h2>
              <p>
                Therosafe is a leading medical device company in Austin, TX,
                providing innovative theranostics solutions for patient care.
                Our cutting-edge technology offers real-time diagnostics and
                personalized treatments to improve patient outcomes.
              </p>
            </div>
          </section>
          <section id="tech" ref={this.tech} className={this.state.techActive}>
            <div className="text">
              <h2>AR Model</h2>
              <p>Place Model Here</p>
            </div>
            <div className="graphic">
              <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <circle cx="50" cy="50" r="50" />
              </svg>
              <svg id="codepen-logo" viewBox="0 0 1792 1792">
          ...
          <section>
            <div className="text">
              <h2>Music</h2>
              <p>
                I also like to play music, and I am currently working on a home
                recorded EP.
              </p>
            </div>
          </section>
